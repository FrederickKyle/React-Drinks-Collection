...
import Ambitious from '../../assets/images/ambitious-creative-co-rick-barrett-UyF3Tal_KXw-unsplash.jpg';
import { AuthCheck } from 'reactfire'

const useStyles = makeStyles({
    logo: {
        content: `url(${Ambitious})`,
        maxWidth: '20%',
        height: 'auto',
    },
    navlogo: {
            ...
            <div className={`${classes.width60} ${classes.alignCenter}`}>
                ...
                <Suspense fallback={'loading...'}>
                    <AuthCheck fallback={
                        ...
                        <li>
                            <Button>
                                <Link to='/Drink_Collection' className={`${classes.navbarItem} ${classes.psides}`}>My Drink Collection</Link>
                            </Button>
                        </li>
                        <li>
                            <Button>
